...
const Footer = () => {
  ...
  return (
    <footer className="footer p-10 bg-base-200 text-base-content">
      <aside>
        <h2 className="text-3xl">@m!t</h2>
        <p>Providing reliable business since 2024</p>
      </aside>
      <nav>
      ...
      <nav>
        ...
        <a className="link link-hover">amit192400@gmail.com</a>
        <a className="link link-hover">+9999999999</a>
      </nav>
